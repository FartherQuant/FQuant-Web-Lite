...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      const res1 = await http.get('https://stock.anno189.com/h5/data/str60p20_echarts_lines.json', {})
      this.v1lineOption=res1.data

      const res2 = await http.get('https://stock.anno189.com/h5/data/str60p20_echarts_pie.json', {})
      this.v1pieOption=res2.data

      const res3 = await http.get('https://stock.anno189.com/h5/data/str60p20_position.json', {})
      
      this.rowsM = res3.data.data.position
      this.rowsN = res3.data.data.tradelog

      const res9 = await http.get('https://stock.anno189.com/h5/data/str60p20.html', {})
